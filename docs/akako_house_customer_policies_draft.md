# Akako House Customer Policies

**Status:** Approved for publication  
**Version:** 2026-07-17  
**Effective date:** July 17, 2026  
**Contact:** support@akakohouse.com  
**Service area:** Washington, DC metropolitan area

These policies are designed to accompany each Akako House custom quote. The quote identifies the event-specific services, price, deposit, location, date, time, guest estimate, and any approved additions. If a quote expressly differs from a general provision below, the quote controls for that event. No placeholder or draft version should be presented for customer acceptance.
...
## 5. Electric coffee roasting, frankincense, and venue safety
...
Refund eligibility is governed by the Cancellation, Rescheduling, and Refund Policy, the accepted quote, and applicable law.
...
- **Identity and contact information:** name, email, telephone number, account identifiers, mailing or event address, and authorized contact information.
- **Event and quote information:** event type, date, time, location, guest count, indoor or venue conditions, access details, service preferences, notes, customer communications, quote amount, deposit, and acceptance status.
- **Accommodation and safety information:** allergy, dietary, accessibility, religious, language, or guest-safety information voluntarily provided for planning. Please provide only information reasonably necessary for service.
...
- maintain safety, food-service, insurance, incident, complaint, and compliance records;
- prevent fraud, misuse, unauthorized access, and scheduling conflicts;
- moderate and publish authorized reviews or media;
- measure service quality and improve operations using information appropriate for that purpose; and
- comply with law, legal process, insurance requirements, and enforceable agreements.
...
- **Analytics providers,** including Google Analytics when enabled, subject to the site's configured analytics and consent practices.
- **Professional advisers and insurers** when reasonably necessary for accounting, legal, insurance, risk, or claim handling.
- **Authorities or other parties** when required by law, legal process, safety need, fraud prevention, protection of rights, or enforcement of an agreement.
- **A successor organization** in a merger, financing, reorganization, or transfer of business assets, subject to appropriate confidentiality and notice where required.
...
Submit a request to support@akakohouse.com. Akako House may verify identity and authority before responding. A request may be limited or denied when information must be retained for payment, tax, contract, safety, insurance, fraud prevention, legal claims, another person's rights, or another lawful reason. Akako House will explain material limitations where required.
...
**Akako House**  
Email: support@akakohouse.com  
Website: https://akakohouse.com

---

# Owner Approval Checklist

Before publication, Akako House should confirm:

1. The 7-day, 48-hour, and no-refund cancellation tiers reflect actual financial strategy.
2. The one-reschedule and 12-month credit rules are acceptable.
3. The ten-business-day refund initiation target is operationally achievable.
4. Virginia governing law is correct for the legal entity and business location.
5. DigitalOcean, Zoho, Stripe, and Google Analytics accurately reflect enabled vendors.
6. A cookie/analytics consent mechanism is added before optional analytics is enabled where required.
7. Customer-data access and deletion requests can be fulfilled operationally.
8. Internal retention practices are documented before promising specific deletion behavior.
9. An attorney licensed for the relevant DC/VA/MD service area reviews limitation-of-liability, force-majeure, cancellation, and privacy language.
10. Each approved policy receives a final version and effective date before it replaces `draft-1` in production.
