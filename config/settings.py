...
BUSINESS_LEGAL_NAME = env("BUSINESS_LEGAL_NAME", default="Akako House LLC")
BUSINESS_PRINCIPAL_ADDRESS = env("BUSINESS_PRINCIPAL_ADDRESS", default="8401 Mayland Dr, Ste A, Richmond, VA 23294")
BUSINESS_ZELLE_TAG = env("BUSINESS_ZELLE_TAG", default="PayAkakoHouse")
